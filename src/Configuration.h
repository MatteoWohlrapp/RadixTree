...
{
    /// sets the overall page_size for the pages written to memory. Subject to constraints: [((PAGE_SIZE - 20) / 2) / 4] > 2, also dividable by 8 for bitmap in storage manager
